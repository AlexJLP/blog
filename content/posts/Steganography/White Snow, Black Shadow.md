...
![_attachments/evidence.jpg](/images/_attachments/evidence.jpg)
First thing that comes to mind is some steganography, let's check with StegSolve:
![_attachments/evidence_steg.gif](/images/_attachments/evidence_steg.gif)Nope. Let's try binwalk:
```
...
![_attachments/hex.png](/images/_attachments/hex.png)
Hex:
```
50 4b 05 06
```
...
![_attachments/textedit.png](/images/_attachments/textedit.png)
